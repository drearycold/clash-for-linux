...
\cp $Conf_Dir/config.yaml $Conf_Dir/config_docker.yaml

sed -ri "s@^external-ui:.*@external-ui: /ui@g" $Conf_Dir/config_docker.yaml
sed -i -e 's/^log-level: .*/log-level: debug/' $Conf_Dir/config_docker.yaml
